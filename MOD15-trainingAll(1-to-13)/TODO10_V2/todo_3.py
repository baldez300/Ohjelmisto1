...
# Continue the program of the previous task as follows,
# that the House class has a parameterless method fire alarm that commands all elevators to the ground floor.
